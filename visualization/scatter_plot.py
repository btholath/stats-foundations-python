...
f = open('/workspaces/stats-foundations-python/visualization/salesdata2.csv','r')
...
plt.savefig("/workspaces/stats-foundations-python/visualization/scatter_plot.png")
